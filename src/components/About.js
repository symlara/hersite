...
function About() {
    return (
      <div>
         <section class="fl w-100 bg-black-50 white items-center">
                <div class="fl pa3 br4 about-items">
                  <h4 class="f2 tc lh-title tracked b">About</h4>
                  <p class="fl f3 tc lh-copy">
                  This site is a place where music fans can come together to celebrate our fav H.E.R as well as communicate and have one centralized
                  place to network and meet new people. <br></br>It will also serve as another info hub for all things H.E.R. 
                  <br>
                  </br>
                  </p>
                </div>
          ...
          <h3 class="f2 tc lh-title tracked b">Follow H.E.R</h3>
          ...
          <a class="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://www.youtube.com/channel/UCFwC3Ryue6CorFm2xCEG0Aw" target="_blank" rel="noreferrer" title="youtube">
            ...
            <a class="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://smarturl.it/HERig?IQid=site" target="_blank" rel="noreferrer" title="Instagram">
            ...
            <a class="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://soundcloud.com/iamhermusic" target="_blank" rel="noreferrer" title="SoundCloud">
            ...
            <a class="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://smarturl.it/HERtw?IQid=site" target="_blank" rel="noreferrer" title="Twitter">
